...
class UserTableMap extends TableMap
{
    ...
    /**
     * the column name for the user_dni field
     */
    const COL_USER_DNI = 'user.user_dni';
     ...
     */
    const COL_USER_REGISTERED = 'user.user_registered';

    /**
     * the column name for the user_updated field
     */
    const COL_USER_UPDATED = 'user.user_updated';

    /**
     * the column name for the user_state field
     */
    const COL_USER_STATE = 'user.user_state';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_USER_DNI);
            $criteria->addSelectColumn(UserTableMap::COL_USER_PHONE);
            $criteria->addSelectColumn(UserTableMap::COL_USER_REGISTERED);
            $criteria->addSelectColumn(UserTableMap::COL_USER_UPDATED);
            $criteria->addSelectColumn(UserTableMap::COL_USER_STATE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.user_dni');
            ...
            $criteria->addSelectColumn($alias . '.user_state');
        }
    }
